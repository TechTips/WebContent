...
<table>
	...
	<tr>
		<td><a href="photo_detail.php?foto_id=01"> <img src="fotos/camino.jpg" class="withBorder" alt="camino" width="75" height="75"></a></td>
		<td>Al agua azul</td>
		<td>22-06-1986</td>
		<td>Pacífico</td>
	</tr>
	<tr>
		<td><a href="photo_detail.php?foto_id=02"> <img src="fotos/rio.jpg" class="withBorder" alt="rio" width="75" height="75"></a></td>
		<td>Río Tajo</td>
		<td>05-10-1999</td>
		<td>Irlanda</td>
	</tr>
	<tr>
		<td><a href="photo_detail.php?foto_id=03"> <img src="fotos/sansa2.jpg" class="withBorder" alt="sansa2" width="75" height="75"></a></td>
		<td>Contemplación montañosa</td>
		<td>18-11-1965</td>
		<td>Francia</td>
	</tr>
	<tr>
		<td><a href="photo_detail.php?foto_id=04"> <img src="fotos/otono.jpg" class="withBorder" alt="rio" width="75" height="75"></a></td>
		<td>Otoño</td>
		<td>25-10-2010</td>
		<td>España</td>
	</tr>
